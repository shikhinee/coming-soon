    ...
    <div className="max-h-screen max-w-screen relative box-border">
      ...
      <div className="flex flex-row box-border w-full justify-between h-16 z-50 px-6 py-8">
        ...
        <div className="flex flex-row gap-6">
          <a className="text-white font-normal" href="">LinkedIn</a>
          <a className="text-white font-normal" href="">Facebook</a>
          <a className="text-white font-normal" href="">Instagram</a>
        </div>
      </div>
      <div className="flex flex-col w-full h-full justify-center items-center gap-10 z-50 pb-16 box-border">
        <h1 className="text-white md:text-[144px] text-[48px] tracking-tighter">Coming Soon</h1>
        <p className="text-white text-[24px] opacity-[0.7]">Hello, our new website is currently under development.</p>
      </div>
      </div>
    </div>
  )
